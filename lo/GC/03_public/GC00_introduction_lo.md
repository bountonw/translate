...
\newpage
    ...
    * **ພາສາລາວ**
        * ສະບັບຕີພິມ ຄ.ສ. 2012; (\GCcode{LO}2012, ບໍ່ມີການກຳກັບ), [ສະບັບ\lw{ອອນລາຍ}\lw{ມີ}\lw{ການ}\lw{ປັບປຸງ}\lw{ຫຼັງຈາກ}\lw{ການ}\lw{ຕີພິມ} ຂໍ້ຄວາມ\lw{ບາງ}\lw{ບ່ອນ}\lw{ຈຶ່ງ}\lw{ແຕກຕ່າງ}\lw{ກັນ}; ຂໍ້\lw{ອ້າງອີງ}\lw{ທີ່}\lw{ບໍ່}\lw{ມີ}\lw{ການ}\lw{ກຳກັບ}\lw{ອີງ}\lw{ໃສ່}\lw{ສະບັບ}\lw{ອອນລາຍ}, ສ່ວນ\lw{ຂໍ້}\lw{ອ້າງອີງ}\lw{ທີ່}\lw{ມີ}\lw{ການ}\lw{ກຳກັບ} \GCcode{LO}2012 ນັ້ນ\lw{ອີງ}\lw{ໃສ່}\lw{ສະບັບ}\lw{ຕີພິມ}.]
        * ສະບັບປັບປຸງໃໝ່ ຄ.ສ. 2023; (\GCcode{LCV}), [ສະບັບ\lw{ນີ້}\lw{ມີ}\lw{ການ}\lw{ປັບປຸງ}\lw{ອອນລາຍ}\lw{ກ່ອນ}\lw{ຕີພິມ}\lw{ເລັກ\p{200}ນ້ອຍ} ແຕ່\lw{ຍັງ}\lw{ຄົງ}\lw{ໃຊ້}\lw{ຊື່}\lw{ເດີມ}.]
        * ພຣະຄຳພີໃໝ່ລຸ້ນເກົ່າ ຄ.ສ. 1972; (\GCcode{LO}1972)
        * ສະບັບລາວບູຮານ; (ສະບັບລາວບູຮານ)
    * **ພາສາໄທ**
        * ໄທຄິງເຈມ; (\GCcode{TKJV})
        * ສະບັບຕີພິມ ຄ.ສ. 1971; (\GCcode{TH}1971)
        * ອະມະຕະທຳຮ່ວມສະໄໝ; (\GCcode{TNCV})
        * New Thai Version (ສະບັບແປໃໝ່); (\GCcode{NTV})
        * ສະບັບຕີພິມ ຄ.ສ. 2011; (\GCcode{THSV})
        * ສະບັບຕີພິມ ຄ.ສ. 1940; (\GCcode{TH}1940)
        * ສະບັບອ່ານເຂົ້າໃຈງ່າຍ; (\GCcode{THA-ERV})
    * **ພາສາອັງກິດ**
        * ສະບັບຄິງເຈມ; (\GCcode{KJV})
