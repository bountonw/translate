...
% Hyphenation Control
% -----------------------------------------------------------------------------
% Disable TeX hyphenation fallbacks (Lao doesn't use hyphens)
\hyphenpenalty=10000
...
\protected\def\egw#1{%
  ...
  \mbox{%
    \fontsize{0.7em}{0.7em}\selectfont
    \textcolor[gray]{0.3}{%
      {\itshape\{#1\}}%
    }%
  }%
...
\@ifundefined{source}{%
  \newcommand{\source}[1]{%
    ...
    \ifprintsourcefoot 
    \enlargethispage{-1.5\baselineskip}% Create space for footer on this page only
