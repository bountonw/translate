...
% =============================================================================
% DEFINE EMPH BEHAVIOR
% =============================================================================
\let\origEmph\emph
\renewcommand{\emph}[1]{\origEmph{#1\/}}
...
% Lao Ellipsis (...)
% -----------------------------------------------------------------------------
% Naming: L = thin space on Left of dots, R = thin space on Right
%
% Core: three dots with nano-stretch, kept nonbreaking
...
% Both sides spaced (word…word)
\DeclareRobustCommand{\elldotsLR}{%
  \hspace{0.2em plus 0.1em minus 0.05em}%
  \mbox{\laoellipsisrubber}%
  \hspace{0.2em plus 0.1em minus 0.05em}%
}
% Left space only (word…punct, word…EOL)
\DeclareRobustCommand{\elldotsL}{%
  \hspace{0.2em plus 0.1em minus 0.05em}%
  \mbox{\laoellipsisrubber}%
}
% Right space only (punct…word, BOL…word)
\DeclareRobustCommand{\elldotsR}{%
  \mbox{\laoellipsisrubber}%
  \hspace{0.2em plus 0.1em minus 0.05em}%
}
% Bare (punct…punct, punct…EOL)
\DeclareRobustCommand{\elldots}{%
  \mbox{\laoellipsisrubber}%
}

% Ender-left, no right space (;…punct, ;…EOL)
\DeclareRobustCommand{\elldotsP}{%
  \nobreak\hspace{0.22em plus .02em minus .01em}%
  \mbox{\laoellipsisrubber}%
}
% Ender-left, right space (;…word)
\DeclareRobustCommand{\elldotsPR}{%
  \nobreak\hspace{0.22em plus .02em minus .01em}%
  \mbox{\laoellipsisrubber}%
  \hspace{0.2em plus 0.1em minus 0.05em}%
}
