...
\AtBeginDocument{\fontsize{10.95pt}{12.6pt}\selectfont} % increased to 10.95 from 10.5 to remove error about shape not available
...
\renewcommand{\cftbeforetoctitleskip}{0.2in}        % Title is 1in from top
