...
chapter:
  number: 16
  title:
    th: เสียงเรียกร้องให้ฟื้นฟู
    en: Calls for a Revival
  url: https://egwwritings.org/read?panels=p98.739&index=0
---

## {1SM 121.1}

### ความจำเป็นเร่งด่วนของคริสตจักร
...
ผู้นำรุ่นเก่าที่เคยชูธงแห่งความเชื่อมีประสบการณ์ในการทุ่มเทจิตใจอธิษฐานเสมือนเป็นการปล้ำสู้กับพระเจ้า และพระองค์ทรงเทพระวิญญาณของพระองค์ให้แก่พวกเขา แต่คนเหล่านี้กำลังล้มหายตายจากไปทีละคน แล้วใครเล่าจะมาแทนที่พวกเขา คนรุ่นใหม่ละ พวกเขาได้มอบถวายชีวิตแด่พระเจ้าอย่างแท้จริงแล้วหรือยัง เราตื่นตัวกับงานที่กำลังดำเนินอยู่ในพลับพลาบนสวรรค์หรือไม่ หรือเรากำลังรอให้มีอำนาจบางอย่างมากระตุ้นคริสตจักรก่อนเราถึงจะตื่นขึ้น เรากำลังหวังที่จะเห็นสมาชิกคริสตจักรทั้งหมดฟื้นฟูขึ้นอีกครั้งหรือเปล่า จะไม่มีวันนั้น {1SM 122.1}
